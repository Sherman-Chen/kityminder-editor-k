 ...
 */
const { xml2json, parseXML } = require('./utils');
const zip = require('@zip.js/zip.js/lib/zip-no-worker.js');

module.exports = {
  name: 'xmind',
  deal: function (minder) {
    // 标签 map
    var markerMap = {
    ...
    return {
      ...
      encode: function (json, km, options) {
        var url = window['NATIVE_SUPPORT_EXPORT_URL'] || 'native-support/export.php';
